...
*  %^EPSCHWA:o  Epenthetic -o- placeholder
...
* m2       for possessive suffix -(o)m
* o2       deleting schwa
* u2       u that keeps following schwa from deleting (-C(u) ~ -Cuwok, rather than -C(u) ~ -Cuk)
...
* %^EPSCHWA  epenthetic schwa in front of certain suffixes (poss -m, loc -k)
