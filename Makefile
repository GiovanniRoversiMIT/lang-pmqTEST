...
CONFIG_CLEAN_FILES = giella-crk.pc manifest.toml \
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/giella-crk.pc.in \
...
ZIP = /usr/bin/zip
abs_builddir = /Users/giovanniroversi/Documents/Scuola/Research/GiellaT/langtech_PMQ_TEST/lang-crk
abs_srcdir = /Users/giovanniroversi/Documents/Scuola/Research/GiellaT/langtech_PMQ_TEST/lang-crk
...
$(am__aclocal_m4_deps):
giella-crk.pc: $(top_builddir)/config.status $(srcdir)/giella-crk.pc.in
